...
<p align="center">
  ...
  <a href="LICENSE"><img src="https://img.shields.io/badge/授權-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

<p align="center">
  <a href="../README.md">🇺🇸 English</a> · <a href="./README_zh-CN.md">简体中文</a> · <a href="./README_zh-HK.md">香港粵語</a> · <b>🇨🇳 繁體中文</b>
</p>
...
**OpenClaw Go** 是基於 [OpenClaw](https://github.com/openclaw/openclaw) 的最佳化分支：

- **Go** = **Global** + **Optimized**
  - 🌍 **Global**：全球化支援，多語言適配
  - ⚡ **Optimized**：效能最佳化，程式碼結構最佳化
- 🌐 **完整多語言支援** - CLI、Web 介面、配置精靈已支援 4 種語言
- 🔄 **上游同步** - 定期合併上游安全修正與功能更新

> 💡 **注意**：本專案使用 Node.js/TypeScript 開發，"Go" 代表 Global + Optimized，不是 Go 語言。

---

## ✨ 功能

- **🌐 多語言支援** — 完整支援英文、簡體中文、香港粵語、繁體中文（4,240+ 翻譯條目）
- **🏠 本地優先** — 資料儲存在您自己的裝置上，隱私可控
- **📱 多渠道支援** — WhatsApp、Telegram、Slack、Discord、Signal、iMessage、Google Chat、Microsoft Teams
- **🎙️ 語音互動** — macOS/iOS/Android 語音喚醒與對話
- **🖼️ Canvas 畫布** — 智慧體驅動的視覺化工作區
- **🔧 技能擴充** — 內建技能 + 自訂工作區技能
...
本專案基於 [openclaw/openclaw](https://github.com/openclaw/openclaw) 進行最佳化與多語言支援，定期與上游保持同步。

**已合併上游更新**：
- ✅ SSRF 安全修正
- ✅ 關鍵安全修正（LFI、程式碼執行阻止）
- ✅ 閘道功能改進（時間戳、路由）
- ✅ Agent 與 Channel Bug 修正
- ✅ 程式碼風格統一（import 排序）
...
基於 [OpenClaw](https://github.com/openclaw/openclaw) 開發，感謝原專案開發者 🦞
...
<p align="center">
  基於 <a href="https://github.com/openclaw/openclaw">OpenClaw</a> · 感謝原專案開發者 🚀
</p>
