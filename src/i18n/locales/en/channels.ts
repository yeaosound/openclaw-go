...
export const channelMessages = {
  ...
  // Config migration
  'channel.slack.configWritesDisabled': 'Slack config writes disabled; skipping channel config migration.',
  ...
  // Config migration
  'channel.telegram.configWritesDisabled': 'Telegram config writes disabled; skipping group config migration.',

  // ==================== Signal ====================
  'channel.signal.reactionsDisabled': 'Signal agent reactions disabled (reactionLevel="{level}").',
  'channel.signal.reactionsDisabledViaActions': 'Signal reactions are disabled via actions.reactions.',
