...
- Run {help} for help`,
  ...
  "wizard.tailscale.warning":
    "Tailscale binary not found in PATH or /Applications. Ensure Tailscale is installed from https://tailscale.com/download. You can continue setup, but serve/funnel will fail at runtime.",
  "wizard.tailscale.title": "Tailscale",
  "wizard.config.invalidTitle": "Invalid config",
  "wizard.config.issuesTitle": "Config issues",
  "wizard.config.invalidOutro":
    "Config invalid. Run `{command}` to repair it, then re-run onboarding.",
